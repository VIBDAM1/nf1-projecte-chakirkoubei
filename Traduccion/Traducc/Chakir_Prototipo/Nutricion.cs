...
namespace Chakir_Prototipo
{
    public partial class Nutricion : Form
    {
        ...
        private void alemanToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void afarToolStripMenuItem_Click(object sender, EventArgs e)
        {
